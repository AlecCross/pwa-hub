...
const apps = [
  {
    ...
    icon: '/apps-icons/Rozkladka/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'Img2Text Liard',
    description: 'Розпізнавання тексту з зображень',
    link: 'https://img2text-liard.vercel.app/',
    icon: '/apps-icons/img2text/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'Next PWA Icons',
    description: 'Генератор іконок для PWA',
    link: 'https://next-pwa-icons.vercel.app/',
    icon: '/apps-icons/icons for PWA Webp/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'TxtDiff',
    description: 'Порівняння текстових файлів',
    link: 'https://txtdiff.vercel.app/',
    icon: '/apps-icons/txtdiff-icons/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'PWA Player',
    description: 'Аудіо- та відеопрогравач',
    link: 'https://pwa-player.vercel.app/',
    icon: '/apps-icons/pwa-player/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'Next Stopwatch',
    description: 'Секундомір та таймер',
    link: 'https://next-stopwatch.vercel.app/',
    icon: '/apps-icons/stopwatch/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'Next Audio Extractor',
    description: 'Витягнення аудіо з відео',
    link: 'https://next-audio-extractor.vercel.app/',
    icon: '/apps-icons/AudioExtractorPWA-icons/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'Amoled Saver',
    description: 'Збереження заряду AMOLED-екрану',
    link: 'https://amoled-saver.vercel.app/',
    icon: '/apps-icons/Black Screensaver PWA icons/icon-512.webp', // Додайте шлях до вашого значка
  },
  {
    name: 'Next FFmpeg',
    description: 'Інтерфейс для FFmpeg',
    link: 'https://vercel.com/aleccross-projects/next-ffmpeg',
    icon: '/apps-icons/ffmpeg/icon-512x512.png', // Додайте шлях до вашого значка
  },
];
